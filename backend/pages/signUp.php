            ...
            <section class="auth-section">
                <div class="auth-container registration">
                    ...
                    <form class="login__form form login__form">
                        <label class="custom-label login__input" autocomplete="name" placeholder="mail" name="name">
                            Name
                            <input autocomplete="name" placeholder="name" name="name" class="login__input custom-input">
                        </label>
                        ...
                        <label class="custom-label login__input" type="password" autocomplete="current-password" placeholder="password" name="password">
                            Password
